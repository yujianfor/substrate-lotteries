...
/// Execute sequential phragmen on the given input and return the result. The return type is list of
/// winners and a weight distribution vector of all voters who contribute to the winners.
///
...
///   ensure they have received enough members
...
///   [`crate::SupportMap`] for more info. Note that this backing stake is compute in
///   ExtendedBalance and may be slightly different that what will be computed from the support map,
///   due to accuracy loss.
/// - The accuracy of the returning edge weight distribution can be configured via the `P` generic
///   argument.
